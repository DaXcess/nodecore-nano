...
export class Guid {
  ...
  public toString(): string {
    return `${h2s(this._a)}${h2s(this._b)}${h2s(this._c)}${h2s(this._d)}-${h2s(this._e)}${h2s(this._f)}-${h2s(this._g)}${h2s(
      this._h
    )}-${h2s(this._i)}${h2s(this._j)}-${h2s(this._k)}${h2s(this._l)}${h2s(this._m)}${h2s(this._n)}${h2s(this._o)}${h2s(
      this._p
    )}`;
  }
}
